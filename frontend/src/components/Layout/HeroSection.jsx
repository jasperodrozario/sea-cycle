      ...
      <section className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 p-4 px-12 lg:px-24 xl:px-32 2xl:px-40 max-w-6xl mx-auto">
          <div className="mb-8">
            ...
            <h2 className="text-4xl md:text-6xl font-bold mb-8 text-white drop-shadow-lg">
              One Cycle at a Time
            </h2>
          </div>

          <p className="text-lg w-160 md:text-xl max-w-4xl mx-auto mb-12 text-blue-100 leading-relaxed">
